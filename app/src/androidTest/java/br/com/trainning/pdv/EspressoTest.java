...
public class EspressoTest {
    ...
    private final String TESTE_DESCRICAO="Produto Teste Lucas";
    private final String TESTE_UNIDADE="pc";
    private final String TESTE_PRECO="4.83";
    private final String TESTE_CODIGO_BARRA="382171129";
    ...
    public void cadastroNovoProduto(){
        ...
        IdlingResource idlingResource9 = new ElapsedTimeIdlingResource(500);
        Espresso.registerIdlingResources(idlingResource9);

        onView(withId(getResourceId("editTextCodigoBarras")))
        ...
        onView(withId(getResourceId("editTextCodigoBarras"))).check(matches(withText(TESTE_CODIGO_BARRA)));

        onView(withId(getResourceId("editTextDescricao"))).perform(clearText(), typeText(TESTE_DESCRICAO_REPLACE));
        onView(withId(getResourceId("editTextDescricao"))).perform(closeSoftKeyboard());
        Espresso.registerIdlingResources(new ElapsedTimeIdlingResource(5000));
        onView(withId(getResourceId("editTextUnidade"))).perform(clearText(), typeText(TESTE_UNIDADE_REPLACE));
        onView(withId(getResourceId("editTextUnidade"))).perform(closeSoftKeyboard());
        Espresso.registerIdlingResources(new ElapsedTimeIdlingResource(5000));
        onView(withId(getResourceId("editTextPreco"))).perform(closeSoftKeyboard());
